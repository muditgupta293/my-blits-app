...
export default Blits.Component('Loader', {
  template: `
    <Element>
      ...
      <Circle size="40" :color="$loaderColor || '#94a3b8'" x="60" :alpha.transition="{value: $alpha, delay: 200}" />
      <Circle size="40" :color="$loaderColor || '#94a3b8'" x="120" :alpha.transition="{value: $alpha, delay: 200}" />
    </Element>
  `,
  /**
   * @type {['loaderColor']}

...
export default Blits.Component("GenreCollection", {
  ...
  template: `
    <Element w="1920" h="1080" color="#1e293b">
      <Element
        x="50"
        :y.transition="{value: $offsetYWrapper + 150, delay: 200, easing: 'cubic-bezier(0.20, 1.00, 0.80, 1.00)'}"
        w="100%"
        h="300"
      >
      ...
      <Card
        ...
        :y.transition="{ value: ((Math.floor($index / 5) * 500) - $offsetY) + 250, delay: 50, duration: 500 }"
